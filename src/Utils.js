...
const truncateAfter = (str, pattern) => {
  return str.slice(0, str.indexOf(pattern) + pattern.length);
}

// core components
// https://developers.google.com/web/updates/2012/06/How-to-convert-ArrayBuffer-to-and-from-String
const str2ab = (str) => {
  const str2 = truncateAfter(str, "%%EOF");
  let buf = new ArrayBuffer(str2.length * 2); // 2 bytes for each char
